...
public class Quiz_08 extends Quiz {
    private final int wrongAnswer1 = 7600;
    private final int wrongAnswer2 = 9200;
    private final int correctAnswer = 8400;
    private final String question = "Der neue \"Brockhaus\" besteht aus 24 Bänden.\n" +
